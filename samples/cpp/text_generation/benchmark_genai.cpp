...
int main(int argc, char* argv[]) try {
    ...
    ("a,attention_backend", "Attention backed used for LLMPipeline", cxxopts::value<std::string>()->default_value("PA"))
    ("h,help", "Print usage");
